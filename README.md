...
* Once everything is installed head over to the `config.json` file and input all the missing fields. 
	* Product SKUs: The numerical ID of the product you want to monitor 
		* This can be found at the end of the product's URL - *ex: https://www.bestbuy.com/site/apple-10-2-inch-ipad-latest-model-with-wi-fi-32gb-space-gray/5199701.p?skuId=**5199701*** - The SKU you would use is the bolded text at the end of the URL. 
